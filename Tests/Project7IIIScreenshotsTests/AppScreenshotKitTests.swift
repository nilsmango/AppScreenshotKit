...
// @testable import Project7IIIScreenshots
...
//             resourceBaseURL: packageRootURL.appending(path: "Sources/Project7IIIScreenshots/Resources/AppleDesignResource")
//         )
...
//                 atPath: packageRootURL.appending(path: "Tests/Project7IIIScreenshotsTests/Results/Compare").path(),
//                 withIntermediateDirectories: true
//             )
//             FileManager.default
//                 .createFile(
//                     atPath: packageRootURL
//                         .appending(path: "Tests/Project7IIIScreenshotsTests/Results/Compare/\(fileName)")
